package com.pratikvelani.bombsweeper.g3d;
...
/**
 * Created by pratikvelani on 09/07/17.
 */

public class ClickAdapter extends InputAdapter {
     ...
     * @see #ClickAdapter(int)
     * @param screenX
     * @param screenY
     * @param pointer
     * @param button */
    public ClickAdapter(int screenX, int screenY, int pointer, int button) {
    }

    /** @see #setButton(int) */
    public ClickAdapter (int button) {
        this.button = button;
    }
    ...
    public boolean touchDragged(int screenX, int screenY, int pointer) {
        ...
        pressed = true;//isOver(event.getListenerActor(), x, y);
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        if (pointer == pressedPointer) {
            if (!cancelled) {
                boolean touchUpOver = true;//isOver(event.getListenerActor(), x, y);
